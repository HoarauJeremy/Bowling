        ...
        <div class='w-full h-full'>
            ...
            <div class='w-full py-2'>
                ...
                <div class='py-4 bg-primary mx-auto rounded-md w-11/12 md:w-3/12 my-8'>
                    <a href='index.php?url=Reservations/ShowReservations' class='w-full flex justify-center items-center text-2xl text-white font-bold font-Roboto md:text-xl'>Réserver</a>
                </div>
            </div>
        </div>
    ";
